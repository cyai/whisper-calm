...
import { getCurrentBoard } from "../../../components/features/Boards/BoardSlice";
                                    ...
                                    <div className=" md:py-5 md:px-10 px-3">
                                        <div className="title mb-5 ">
                                            ...
                                            <p className="text-[0.8rem] text-gray-600 mt-1 dark:text-gray-400">
                                                Enter the subject, this will be
                                                shown as heading of your thread
                                            </p>
                                            <input
                                                id="subject"
                                                name="subject"
